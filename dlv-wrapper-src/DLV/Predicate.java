...
public class Predicate
{
  ...
  public Predicate(String paramString, PredicateMetaData paramPredicateMetaData)
  {
    if (paramString == null)
      throw new NullPointerException("name cannot be null");
    this.name = paramString;
    this.arity = paramPredicateMetaData.getArity();
  ...
  public String getTermAt(int paramInt1, int paramInt2)
  {
    ...
    if (this.metadata == null)
      return ConversionType.objectToString(this.impl.getTerm(paramInt1, paramInt2), 2);
  ...
  public Literal getLiteral(int paramInt)
  {
    ...
    if (this.metadata == null)
      for (i = 0; ; ++i)
      {
        if (i >= this.arity)
          break label111;
        arrayOfString[i] = ConversionType.objectToString(this.impl.getTerm(paramInt, i), 2);
      }
    ...
    boolean equalTo(Object[] paramArrayOfObject, boolean paramBoolean)
    {
      ...
      for (int i = 0; i < this.term.length; ++i)
      {
        ...
        if (this.this$0.metadata == null)
          ...
          str = ConversionType.objectToString(paramArrayOfObject[i], this.this$0.metadata.getType(i + 1));
  ...
  class InMemoryPI extends PredicateImplementation
  {
    ...
    void updateImplementation(int paramInt, Object[] paramArrayOfObject, Boolean paramBoolean)
    {
      if ((paramInt < 0) || (paramInt >= this.list.size()))
        throw new NoSuchLiteralException();
      Predicate.LiteralHandler localLiteralHandler = new Predicate.LiteralHandler(Predicate.this, null);
        ...
        if (Predicate.this.metadata == null)
          for (i = 0; ; ++i)
          {
            if (i >= Predicate.this.arity)
              break label174;
            localLiteralHandler.term[i] = ConversionType.objectToString(paramArrayOfObject[i], 2);
          }
        for (int i = 0; ; ++i)
        {
          if (i >= Predicate.this.arity)
            break label174;
          localLiteralHandler.term[i] = ConversionType.objectToString(paramArrayOfObject[i], Predicate.access$500(Predicate.this).getType(i + 1));
        }
      }
      throw new NullPointerException();
    ...
    Object getTerm(int paramInt1, int paramInt2)
    {
      ...
      if (Predicate.this.metadata == null)
        return ConversionType.stringToObject(localLiteralHandler.term[paramInt2], 2);
  ...
  public class Literal
  {
    ...
    public Literal(String[] arg2)
    {
      Object localObject;
      if (localObject.length != Predicate.this.arity)
        throw new BadArityException();
      int i = 0;
      ...
      this.term = localObject;
    }

    public Literal(String[] paramBoolean, boolean arg3)
    {
    ...
    {
      return new Literal(Predicate.this, this.term, !this.positive);
    }
