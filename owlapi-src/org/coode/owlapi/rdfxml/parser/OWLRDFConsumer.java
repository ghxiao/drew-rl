...
public class OWLRDFConsumer implements RDFConsumer {
    ...
    //Xiao:LDL
    private ObjectPropertyExpressionTranslatorSelector objectPropertyExpressionTranslatorSelector;
    ...
    public OWLRDFConsumer(OWLOntologyManager owlOntologyManager, OWLOntology ontology, AnonymousNodeChecker checker) {
        ...
        //Xiao:LDL
        objectPropertyExpressionTranslatorSelector = new ObjectPropertyExpressionTranslatorSelector(this);
...
//        }
        ...
        //OWLObjectPropertyExpression desc = translatedObjectPropertyExpression.get(mainNode);
        if (prop == null) {
            ...
            if (translator != null) {
                ...
                return getDataFactory().getOWLObjectProperty(mainNode);
            }
        }
        return prop;
    }
    ...
    */
    ...
    //Xiao: LDL
	public Set<OWLObjectPropertyExpression> translateToObjectPropertyExpressionSet(IRI mainNode) {
		return objectPropertyListTranslator.translateToSet(mainNode);
