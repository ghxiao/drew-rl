...
public class OWLDataFactoryImpl implements OWLDataFactory {
	...
	public OWLDatatypeRestriction getOWLDatatypeMinMaxInclusiveRestriction(int minInclusive, int maxInclusive) {
		return getOWLDatatypeRestriction(getIntegerOWLDatatype(), getOWLFacetRestriction(OWLFacet.MIN_INCLUSIVE, getOWLTypedLiteral(minInclusive)),
	...
	public OWLDatatypeRestriction getOWLDatatypeMinMaxExclusiveRestriction(int minExclusive, int maxExclusive) {
		return getOWLDatatypeRestriction(getIntegerOWLDatatype(), getOWLFacetRestriction(OWLFacet.MIN_EXCLUSIVE, getOWLTypedLiteral(minExclusive)),
	...
	public OWLEquivalentObjectPropertiesAxiom getOWLEquivalentObjectPropertiesAxiom(OWLObjectPropertyExpression propertyA,
			OWLObjectPropertyExpression propertyB, Set<? extends OWLAnnotation> annotations) {
	...
	public OWLNegativeDataPropertyAssertionAxiom getOWLNegativeDataPropertyAssertionAxiom(OWLDataPropertyExpression property, OWLIndividual subject,
			OWLLiteral object) {
	...
	public OWLNegativeObjectPropertyAssertionAxiom getOWLNegativeObjectPropertyAssertionAxiom(OWLObjectPropertyExpression property, OWLIndividual subject,
	...
	public OWLObjectPropertyAssertionAxiom getOWLObjectPropertyAssertionAxiom(OWLObjectPropertyExpression property, OWLIndividual individual,
			OWLIndividual object) {
	...
	// 
	// Xiao
	// LDL Property Expressions
	//
	// //////////////////////////////////////////////////////////////////////////////////

	public LDLObjectPropertyIntersectionOf getLDLObjectPropertyIntersectionOf(Set<? extends OWLObjectPropertyExpression> operands) {
		return new LDLObjectPropertyIntersectionOfImpl(this, operands);
	}

	public LDLObjectPropertyIntersectionOf getLDLObjectPropertyIntersectionOf(OWLObjectPropertyExpression... operands) {
		return getLDLObjectPropertyIntersectionOf(CollectionFactory.createSet(operands));
	}

	public LDLObjectPropertyTransitiveClosureOf getLDLObjectPropertyTransitiveClosureOf(OWLObjectPropertyExpression operand) {
		return new LDLObjectPropertyTransitiveClosureImpl(this, operand);
	}

	public LDLObjectPropertyUnionOf getLDLObjectPropertyUnionOf(Set<? extends OWLObjectPropertyExpression> operands) {
		return new LDLObjectPropertyUnionOfImpl(this, operands);
	}

	@Override
	public LDLObjectPropertyUnionOf getLDLObjectPropertyUnionOf(OWLObjectPropertyExpression... operands) {
		return getLDLObjectPropertyUnionOf(CollectionFactory.createSet(operands));
	}

	@Override
	public LDLObjectPropertyChainOf getLDLObjectPropertyChainOf(Set<? extends OWLObjectPropertyExpression> operands) {
		return new LDLObjectPropertyChainOfImpl(this, operands);
	}
