...
public enum OWLRDFVocabulary {
	 ...
	 * xiao:LDL
	 */
	LDL_OBJECT_PROPERTY_TRANSITIVE_CLOSURE_OF(Namespaces.LDL, "objectPropertyTransitiveClosureOf"),
	...
	LDL_OBJECT_PROPERTY_ONE_OF(Namespaces.LDL, "objectPropertyOneOf"), 
	
	LDL_INDIVIDUAL_PAIR(Namespaces.LDL,"individualPair");
