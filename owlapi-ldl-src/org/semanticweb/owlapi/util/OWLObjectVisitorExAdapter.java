...
public class OWLObjectVisitorExAdapter<O> implements OWLObjectVisitorEx<O> {
	...
	@Override
	public O visit(LDLObjectPropertyIntersectionOf property) {
		return getDefaultReturnValue(property);
	}

	@Override
	public O visit(LDLObjectPropertyUnionOf property) {
		return getDefaultReturnValue(property);
	}

	@Override
	public O visit(LDLObjectPropertyTransitiveClosureOf property) {
		return getDefaultReturnValue(property);
	}

	@Override
	public O visit(LDLObjectPropertyChainOf ldlObjectPropertyChainOfImpl) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public O visit(LDLObjectPropertyOneOf property) {
		// TODO Auto-generated method stub
		return null;
	}
}
