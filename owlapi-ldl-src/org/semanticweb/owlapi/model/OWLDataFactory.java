...
public interface OWLDataFactory extends SWRLDataFactory {
	 ...
	 * 
	 * @param id
	 *            The node ID. Note that the ID will be preixed with _: if it is
	 *            not specifed with _: as a prefix
	...
	/**
	 * Creates a typed literal that has the specified OWL 2 Datatype as its
	 * datatype
	 * 
	 * @param literal
	 *            The literal
	 ...
	 * 
	 * @throws NullPointerException
	 *             if owlEntity or annotations is <code>null</code>
	 */
	...
	OWLNegativeObjectPropertyAssertionAxiom getOWLNegativeObjectPropertyAssertionAxiom(OWLObjectPropertyExpression property, OWLIndividual subject,
	...
	OWLNegativeDataPropertyAssertionAxiom getOWLNegativeDataPropertyAssertionAxiom(OWLDataPropertyExpression property, OWLIndividual subject,
	...
	LDLObjectPropertyIntersectionOf getLDLObjectPropertyIntersectionOf(Set<? extends OWLObjectPropertyExpression> operands);

	LDLObjectPropertyIntersectionOf getLDLObjectPropertyIntersectionOf(OWLObjectPropertyExpression... operands);

	LDLObjectPropertyUnionOf getLDLObjectPropertyUnionOf(Set<? extends OWLObjectPropertyExpression> operands);
