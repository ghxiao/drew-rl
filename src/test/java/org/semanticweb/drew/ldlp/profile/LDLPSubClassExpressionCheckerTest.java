...
import org.semanticweb.drew.ldlp.profile.LDLPSubClassExpressionChecker;
...
public class LDLPSubClassExpressionCheckerTest {

	static LDLPSubClassExpressionChecker checker;
	...
	public static void setUpBeforeClass() throws Exception {
		checker = new LDLPSubClassExpressionChecker();
	...
	public void testVisitOWLObjectIntersectionOfEx() {
		assertTrue(factory.getOWLObjectIntersectionOf(E_min_2_C, O, A_or_B).accept(checker));
	}

	@Test
	public void testVisitOWLObjectUnionOf() {
		assertTrue(A_or_B.accept(checker));
	}
	...
	public void testVisitOWLObjectSomeValuesFrom() {
		assertTrue(E_some_C.accept(checker));
	}

	@Test
	public void testVisitOWLObjectAllValuesFrom() {
		assertFalse(E_only_C.accept(checker));
	}

	@Test
	public void testVisitOWLObjectHasValue() {
		assertTrue(E_value_o1.accept(checker));
	}

	@Test
	public void testVisitOWLObjectMinCardinality() {
		assertTrue(E_min_2_C.accept(checker));
	}
